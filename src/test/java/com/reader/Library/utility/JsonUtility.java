...
public class JsonUtility {
    ...
    public static Reader getReaderRequest(String fileName) throws Exception {
        return JsonUtility.readValue(JsonUtility.getResourceAsString(fileName), Reader.class);
    }

    public static Book getBookRequest(String fileName) throws Exception {
        return JsonUtility.readValue(JsonUtility.getResourceAsString(fileName), Book.class);
    }
